...
import { CartTotalResult } from '../types/cart';
import {
...
const calculateCartTotal = (cartList: HTMLElement, products: Product[]): CartTotalResult => {
  let totalPrice = 0;
...
const renderStockStatusMessage = (products: Product[], stockStatus: HTMLElement): void => {
...
const getOrCreateRewardPointsElement = (cartTotalPrice: HTMLElement): HTMLElement => {
